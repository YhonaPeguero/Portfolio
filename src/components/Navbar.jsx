...
const Navbar = () => {
  ...
  return (
    ...
    /* sticky top-0  h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 */
    <div className=" sticky top-0  h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
          ...
          <ul className="hidden md:flex">
            <li>
              <Link
                ...
                smooth={true}
                duration={500}
                className="px-3 py-2 hover:bg-pink-600 hover:border-pink-600 transition-all duration-300"
              >
                Inicio
              </Link>
            </li>
